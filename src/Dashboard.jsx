...
export default function Dashboard() {
  ...
  if (!student) {
    return <div className="text-white p-4">No student data.</div>;
  }

  return (
    <div className="default">
      <h1 className="md:text-3xl text-2xl font-bold text-gray-100 mb-4">
        DASHBOARD
      </h1>
      ...
      <div className="bg-[#067706] rounded-xl p-5 shadow-md border border-green-900 mb-6">
        ...
        <p className="text-md text-gray-300 mt-1">
          Academic Session:{" "}
          <span className="text-[#041b04] font-bold">2024/2025</span> | Semester:{" "}
          <span className="text-[#041b04] font-bold">First</span> | Level:{" "}
          <span className="text-[#041b04] font-bold">
            {student.level || "Level"}
          </span>
        </p>
      </div>
        ...
        <div className="bg-[#0b3b0b] p-4 rounded-xl border border-green-900 shadow-md flex items-center justify-between">
          <div>
            <h3 className="text-2xl font-black mb-2">
              New Upload:{" "}
              <span className="text-green-400 text-3xl">3</span>
            </h3>
            <h3 className="text-2xl font-black">
              Complaints:{" "}
              <span className="text-green-400 text-3xl">5</span>
            </h3>
          </div>
          <Bell size={30} className="cursor-pointer" />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-[#0b3b0b] p-4 rounded-xl border border-green-900 shadow-md">
          ...
          <ul className="text-sm text-gray-100 space-y-1">
            <li>
              Math311: Test 20/40 | Exam 70/100{" "}
              <span className="float-right text-gray-100">09/23/25</span>
            </li>
            <li>
              Math301: Test 25/40 | Exam 68/100{" "}
              <span className="float-right text-gray-100">09/22/25</span>
            </li>
            <li>
              Math321: Test 19/40 | Exam 72/100{" "}
              <span className="float-right text-gray-100">09/20/25</span>
            </li>
            <li>
              Math321: Test 19/40 | Exam 72/100{" "}
              <span className="float-right text-gray-100">09/20/25</span>
        ...
        <div className="bg-[#0b3b0b] p-4 rounded-xl border border-green-900 shadow-md">
          ...
          <ul className="list-disc ml-4 text-sm text-gray-100 space-y-1">
            ...
            <li>
              New mathematics lecturer: Prof. Shifaul Animashaun (CoS301).
            </li>
            <li>
              New mathematics lecturer: Prof. Shifaul Animashaun (CoS301).
            </li>
      ...
      <div className="bg-[#0b3b0b] rounded-xl p-4 border border-green-900 shadow-md">
        <h4 className="font-bold text-xl text-green-400 mb-2">
          Motivational Quotes
        </h4>
